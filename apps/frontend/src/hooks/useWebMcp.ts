        ...
        execute: () => ({
          ...
          agentProtocol: {
            firstTurn: [
              ...
              'For a broad first response, do not replace connected-source choices with a generic “Share the essentials” or upload-first prompt. When the relevant connections are available, offer them in this order before manual input: (1) fetch room context from Google Drive, OneDrive, or Dropbox; (2) fetch music preferences from Spotify, Apple Music, or YouTube Music; (3) upload a room photo, floor plan, or reference track; (4) describe the details manually; (5) use named assumptions. Identify connected files for approval before retrieving them, and offer only services available in the current session.',
