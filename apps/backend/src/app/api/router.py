...
from app.api.endpoints import auth, configurations, custom_speakers, room_references, simulate, simulation_audio, speakers
...
router.include_router(simulation_audio.router, tags=["simulation-audio"])
router.include_router(room_references.router, tags=["room-references"])
